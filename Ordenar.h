...
public:
    ...
    Pokemons* startQuickSort(Pokemons Info[], int menor, int mayor)
    {
        QuickSort(Info, menor, mayor);
        return Info;
    }

    void QuickSort(Pokemons Info[], int menor, int mayor)
    {
        if (menor < mayor)
        {
    ...
    int QuickSortPartition(Pokemons Info[], int mayor, int menor)
    {
    ...
    Pokemons* SelectionSort(Pokemons Info[], int mayor, int menor)
    {
    ...
    Pokemons* ShellSort(Pokemons Info[], int mayor, int menor)
    {
